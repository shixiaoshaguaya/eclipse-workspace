...
<script type="text/javascript" language="javascript">
	...
	function check() {
		...
		if (len < 3) {
			...
			if (allforms[0].password.value != allforms[0].repassword.value) {
	...
	<form id="userAction_save_do" name="Form1"
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td bgColor="#ffffff"><input type="text" name="name" /><span
			...
			<tr>
				...
				<td bgColor="#ffffff"><input type="password" name="repassword" /><span
					id="surePswSpan" class="span1"></span></td>

			</tr>
			<tr>
				<td style="WIDTH: 100%" align="center" bgColor="#f5fafe" colSpan="2">
					<input type="submit" value="确定" onclick="return check()"> <FONT
					face="宋体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT> <input
